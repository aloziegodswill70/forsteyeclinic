...
const faqs = [
  {
    icon: <Eye className="text-forstRed w-6 h-6" />,
  ...
  {
    icon: <HelpCircle className="text-forstRed w-6 h-6" />,
...
export default function FaqSection() {
  ...
  // Cycle through FAQs automatically every 10 seconds
  useEffect(() => {
  ...
  return (
    <section className="py-16 bg-gray-50 px-4 sm:px-8 lg:px-16 text-center">
      <h2 className="text-3xl font-bold text-forstRed mb-8">Frequently Asked Questions</h2>
      ...
      <div className="max-w-3xl mx-auto grid gap-6">
        {faqs.map((faq, index) => (
          <div
            ...
            className="bg-white rounded-2xl p-5 shadow hover:shadow-lg transition cursor-pointer flex items-start gap-3"
          >
